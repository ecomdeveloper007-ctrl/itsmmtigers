...
export const MemberProfileAdminModal: React.FC<MemberProfileAdminModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-2xl max-h-[calc(100vh-2rem)] sm:max-h-[calc(100vh-3rem)] bg-white border border-[#e2ebd9] rounded-2xl sm:rounded-3xl shadow-2xl flex flex-col overflow-hidden my-auto"
      ...
      >
        ...
        {/* Footer (Pinned) */}
        <div className="flex-shrink-0 p-4 sm:p-5 border-t border-[#e2ebd9] bg-[#f8faf6] flex justify-end z-10">
          <button
            onClick={onClose}
